...
let rc_intermediate_2_left (l s1 s2 s3:concrete_st) (o1 o2:op_t) (o o':op_t) (o_n:op_t)
: Lemma (requires Fst_then_snd? (rc o1 o2) /\ Fst_then_snd? (rc o o') /\
                  //get_rid o <> get_rid o' (*o,o' must be concurrent *) /\
                  get_rid o_n <> get_rid o' (*o_n,o' must be concurrent*) /\
  ...
  assume (Add? (snd (snd o_n)) /\ get_ele o_n = get_ele o');
...
let intermediate_base_right_one_op_left (l s1 s2 s3:concrete_st) (o o' o1:op_t) 
  ...
  //if Add? (snd (snd o1)) && get_ele o1 = get_ele o' && get_rid o1 = get_rid o' then admit() //done
...
let intermediate_base_left_one_op (l s1 s2 s3:concrete_st) (o o' o1:op_t) 
  ...
  if Add? (snd (snd o1)) && get_ele o1 = get_ele o' && get_rid o1 = get_rid o' then admit() //done
  else if Add? (snd (snd o1)) && get_ele o1 = get_ele o' && get_rid o1 <> get_rid o' then admit() //done
  else if Add? (snd (snd o1)) && get_ele o1 <> get_ele o' && get_rid o1 = get_rid o' then admit() //done
  else if Add? (snd (snd o1)) && get_ele o1 <> get_ele o' && get_rid o1 <> get_rid o' then admit() //done
  else if Rem? (snd (snd o1)) && get_ele o1 = get_ele o' then admit() //done
  else admit() //done
...
let intermediate_base_left_right_one_op (l s1 s2 s3:concrete_st) (o o' o1' o1:op_t) 
  ...
  assume (Either? (rc o o1'));
  if Add? (snd (snd o1)) && get_ele o1 = get_ele o' && get_rid o1 = get_rid o' then admit() //done
  else if Add? (snd (snd o1)) && get_ele o1 = get_ele o' && get_rid o1 <> get_rid o' then () // not done
  else if Add? (snd (snd o1)) && get_ele o1 <> get_ele o' && get_rid o1 = get_rid o' then admit() // done
  else if Add? (snd (snd o1)) && get_ele o1 <> get_ele o' && get_rid o1 <> get_rid o' then admit() // done
  else if Rem? (snd (snd o1)) && get_ele o1 = get_ele o' then admit() // done
  else admit() // done
...
: Lemma (requires Fst_then_snd? (rc o o') /\
      ...
      (ensures eq (merge (do l o') (do s1 o') (do (do (do (do s2 o_n) o) o') o1)) (do (do (do (do s3 o_n) o) o') o1)) = admit()
...
: Lemma (requires Fst_then_snd? (rc o o') /\
      ...
      (ensures eq (merge (do l o') (do (do (do s1 o_n) o) o') (do (do s2 o') o1)) (do (do (do (do s3 o_n) o) o') o1)) = admit()
...
: Lemma (requires Fst_then_snd? (rc o o') /\
      ...
      (ensures eq (merge (do l o') (do s1 o') (do (do (do s2 o_n) o) o')) (do (do (do s3 o_n) o) o')) = admit()
...
: Lemma (requires Fst_then_snd? (rc o o') /\
      ...
      (ensures eq (merge (do l o') (do (do (do s1 o_n) o) o') (do s2 o')) (do (do (do s3 o_n) o) o')) = admit()
...
let comm_ind_right (l a b c:concrete_st) (o1 o2' o2:op_t)
  : Lemma (requires Either? (rc o1 o2) /\ 
                    ...
                    ~ (exists o3 a'. eq (do a o1) (do a' o3) /\ Fst_then_snd? (rc o2 o3)) /\
                    ~ (Fst_then_snd? (rc o1 o2')) /\
                    ~ (exists o3 b'. eq (do (do b o2') o2) (do b' o3) /\ Fst_then_snd? (rc o1 o3)) /\
                    ~ (exists o3 b'. eq (do b o2) (do b' o3) /\ Fst_then_snd? (rc o1 o3)))                    
          (ensures eq (merge l (do a o1) (do (do b o2') o2)) (do (do (merge l a (do b o2')) o2) o1)) = admit()
...
let comm_ind_left (l a b c:concrete_st) (o1 o2' o2:op_t)
  ...
  //if Add? (snd (snd o1)) && Add? (snd (snd o2)) && get_ele o1 = get_ele o2 then admit() //done
...
let comm_intermediate_base_right (l s1 s2 s3:concrete_st) (o o' o1 o2:op_t) 
  : Lemma (requires Rem? (snd (snd o)) /\ Add? (snd (snd o')) /\ get_ele o = get_ele o' /\
                    Add? (snd (snd o1)) /\ Add? (snd (snd o2)) 
                    //get_ele o1 = get_ele o' /\ get_ele o2 = get_ele o' /\ get_rid o1 <> get_rid o' /\ get_rid o2 <> get_rid o'
                    ...
                    /\ eq (merge l (do s1 o1) (do s2 o2)) (do (do s3 o1) o2)) 
          (ensures eq (merge (do l o') (do (do s1 o') o1) (do (do (do s2 o) o') o2)) (do (do (do (do s3 o) o') o1) o2)) = admit()
...
let comm_intermediate_base_left_right (l s1 s2 s3:concrete_st) (o o' o1' o1 o2:op_t) 
  : Lemma (requires Fst_then_snd? (rc o o') /\ Either? (rc o1 o2) /\ Fst_then_snd? (rc o1' o')
        ...
        (ensures eq (merge (do l o') (do (do (do s1 o1') o') o1) (do (do (do s2 o) o') o2)) (do (do (do (do (do s3 o1') o) o') o1) o2)) =
  assume (Either? (rc o1' o)); 
  if Add? (snd (snd o1)) && get_ele o1 = get_ele o' && get_rid o1 = get_rid o' then admit() //done
  else if Add? (snd (snd o2)) && get_ele o2 = get_ele o' && get_rid o2 <> get_rid o' then () //done
  else if Add? (snd (snd o1)) && get_ele o1 <> get_ele o' && get_rid o1 = get_rid o' then admit() //done
  else if Add? (snd (snd o1)) && get_ele o1 <> get_ele o' && get_rid o1 <> get_rid o' then admit() //done
...
let comm_intermediate_1_v1 (l s1 s2 s3:concrete_st) (o1 o2:op_t) (o:op_t{Add? (snd (snd o))})
  : Lemma (requires Either? (rc o1 o2) /\
                    ...
                    //eq (merge l (do s1 o2) (do s2 o1)) (do (do s3 o1) o2) /\ //***EXTRA***
                    eq (merge l (do s1 o1) (do s2 o2)) (do (do s3 o1) o2))
  ...
  assume (forall ele rid. (ele <> get_ele o /\ rid <> get_rid o) ==> (snd (sel_id (sel_e lhs ele) rid) = snd (sel_id (sel_e rhs ele) rid)));*)
  assume (forall ele rid. (ele = get_ele o /\ rid = get_rid o) ==> (fst (sel_id (sel_e lhs ele) rid) = fst (sel_id (sel_e rhs ele) rid)));
  (*assume (forall ele rid. (ele = get_ele o /\ rid = get_rid o) ==> 
                     fst (sel_id (sel_e (do l o) ele) rid) = fst (sel_id (sel_e l ele) rid) + 1);
  assume (forall ele rid. (ele = get_ele o /\ rid = get_rid o) ==> 
                     fst (sel_id (sel_e (do (do (do s3 o) o1) o2) ele) rid) = fst (sel_id (sel_e (do (do s3 o1) o2) ele) rid) + 1);*)
  assume (forall ele rid. (ele = get_ele o /\ rid = get_rid o) ==> 
                     ((fst (sel_id (sel_e (do s1 o1) ele) rid) >= fst (sel_id (sel_e l ele) rid)) ==>
                      (fst (sel_id (sel_e (do (do s1 o) o1) ele) rid) >= fst (sel_id (sel_e (do l o) ele) rid))));
  assume (forall ele rid. (ele = get_ele o /\ rid = get_rid o) ==> 
                     ((fst (sel_id (sel_e (do s2 o2) ele) rid) >= fst (sel_id (sel_e l ele) rid)) ==>
                      (fst (sel_id (sel_e (do (do s2 o) o2) ele) rid) >= fst (sel_id (sel_e (do l o) ele) rid))));
  assume (forall ele rid. (ele = get_ele o /\ rid = get_rid o) ==> 
                     ((fst (sel_id (sel_e (do s1 o1) ele) rid) < fst (sel_id (sel_e l ele) rid)) ==>
                      (fst (sel_id (sel_e (do (do s1 o) o1) ele) rid) < fst (sel_id (sel_e (do l o) ele) rid))));
  assume (forall ele rid. (ele = get_ele o /\ rid = get_rid o) ==> 
                     ((fst (sel_id (sel_e (do s2 o2) ele) rid) < fst (sel_id (sel_e l ele) rid)) ==>
                      (fst (sel_id (sel_e (do (do s2 o) o2) ele) rid) < fst (sel_id (sel_e (do l o) ele) rid))));
  if get_ele o = get_ele o2 then
    (assert (forall ele rid. (ele = get_ele o /\ rid = get_rid o) ==> (snd (sel_id (sel_e lhs ele) rid) = snd (sel_id (sel_e rhs ele) rid)));
     admit())
...
(*if Add? (snd (snd o1)) && Add? (snd (snd o2)) && get_ele o1 = get_ele o2 && get_rid o1 = get_rid o2 && get_ele o = get_ele o2 && get_rid o = get_rid o2 then admit() //done
  else if Add? (snd (snd o1)) && Add? (snd (snd o2)) && get_ele o1 = get_ele o2 && get_rid o1 = get_rid o2 && get_ele o = get_ele o2 && get_rid o <> get_rid o2 then admit() //done
  else if Add? (snd (snd o1)) && Add? (snd (snd o2)) && get_ele o1 = get_ele o2 && get_rid o1 = get_rid o2 && get_ele o <> get_ele o2 && get_rid o = get_rid o2 then admit() //done
  else if Add? (snd (snd o1)) && Add? (snd (snd o2)) && get_ele o1 = get_ele o2 && get_rid o1 = get_rid o2 && get_ele o <> get_ele o2 && get_rid o <> get_rid o2 then admit() //done
  else if Add? (snd (snd o1)) && Add? (snd (snd o2)) && get_ele o1 = get_ele o2 && get_rid o1 <> get_rid o2 && get_ele o = get_ele o2 && get_rid o = get_rid o2 then admit() //done
  else if Add? (snd (snd o1)) && Add? (snd (snd o2)) && get_ele o1 = get_ele o2 && get_rid o1 <> get_rid o2 && get_ele o = get_ele o2 && get_rid o <> get_rid o2 then admit() //not done
  else if Add? (snd (snd o1)) && Add? (snd (snd o2)) && get_ele o1 = get_ele o2 && get_rid o1 <> get_rid o2 && get_ele o <> get_ele o2 && get_rid o = get_rid o2 then admit() //done
  else if Add? (snd (snd o1)) && Add? (snd (snd o2)) && get_ele o1 = get_ele o2 && get_rid o1 <> get_rid o2 && get_ele o <> get_ele o2 && get_rid o <> get_rid o2 then admit() //done
  else if Add? (snd (snd o1)) && Add? (snd (snd o2)) && get_ele o1 <> get_ele o2 && get_rid o1 = get_rid o2 && get_ele o = get_ele o2 && get_rid o = get_rid o2 then admit() //done
    if Add? (snd (snd o1)) && Add? (snd (snd o2)) && get_ele o1 <> get_ele o2 && get_rid o1 = get_rid o2 && get_ele o = get_ele o2 && get_rid o <> get_rid o2 then () //done
   if Add? (snd (snd o1)) && Add? (snd (snd o2)) && get_ele o1 <> get_ele o2 && get_rid o1 = get_rid o2 && get_ele o <> get_ele o2 && get_rid o = get_rid o2 then admit() //done
  else if Add? (snd (snd o1)) && Add? (snd (snd o2)) && get_ele o1 <> get_ele o2 && get_rid o1 = get_rid o2 && get_ele o <> get_ele o2 && get_rid o <> get_rid o2 then admit() //done
  else if Add? (snd (snd o1)) && Add? (snd (snd o2)) && get_ele o1 <> get_ele o2 && get_rid o1 <> get_rid o2 && get_ele o = get_ele o2 && get_rid o = get_rid o2 then admit() //done
  else if Add? (snd (snd o1)) && Add? (snd (snd o2)) && get_ele o1 <> get_ele o2 && get_rid o1 <> get_rid o2 && get_ele o = get_ele o2 && get_rid o <> get_rid o2 then admit() //not done
