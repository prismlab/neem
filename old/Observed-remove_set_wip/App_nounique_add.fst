...
let ind_case_last1_neq_c2_last1_rem_neq (lca s1 s2:st)
  : Lemma (requires (Seq.length (ops_of s1) > Seq.length (ops_of lca) /\
                    (let s1' = inverse_st s1 in
                    common_pre1 lca s1 s2 /\
                    (let s2' = inverse_st s2 in
                    ...
                    is_prefix (ops_of lca) (ops_of s2') /\
                    not (exists_triple last2 (diff (ops_of s1) (ops_of lca))) /\
                    not (exists_triple last1 (diff (ops_of s2) (ops_of lca))) /\ //extra pre cond added
                    concrete_merge_pre (v_of lca) (v_of s1') (v_of s2') /\
                    concrete_merge_pre (v_of lca) (v_of s1) (v_of s2') /\
                    concrete_merge_pre (v_of lca) (v_of s1) (v_of s2) /\
                    concrete_merge_pre (v_of lca) (v_of s1') (v_of s2) /\
  ...
  assume (L.mem (fst last2, get_ele last2) (concrete_merge (v_of lca) (v_of s1') (v_of s2))); 
  assume (L.mem (fst last2, get_ele last2) (v_of lca) \/
          L.mem (fst last2, get_ele last2) (v_of s1) \/ 
          L.mem (fst last2, get_ele last2) (v_of s2)); 

  assume (forall e. L.mem e (v_of s1) <==> L.mem e (v_of s1') /\ snd e <> get_ele last1);
  assume (snd (fst last2, get_ele last2) <> get_ele last1);
  
  assume (L.mem (fst last2, get_ele last2) (v_of s1') ==> L.mem (fst last2, get_ele last2) (v_of s1));
  
  assume ( L.mem (fst last2, get_ele last2) (diff_s (v_of s1') (v_of lca)) ==>
           L.mem (fst last2, get_ele last2) (diff_s (v_of s1) (v_of lca)));

  assume ((L.mem (fst last2, get_ele last2) (v_of lca) /\ 
           L.mem (fst last2, get_ele last2) (v_of s1') /\ 
           L.mem (fst last2, get_ele last2) (v_of s2)) ==>
           (L.mem (fst last2, get_ele last2) (v_of lca) /\ 
           L.mem (fst last2, get_ele last2) (v_of s1) /\ 
           L.mem (fst last2, get_ele last2) (v_of s2)));  
  ...
  assume ((L.mem (fst last2, get_ele last2) (v_of lca) /\ 
           ...
           L.mem (fst last2, get_ele last2) (v_of s2)) \/
           (L.mem (fst last2, get_ele last2) (diff_s (v_of s1) (v_of lca))) \/
           (L.mem (fst last2, get_ele last2) (diff_s (v_of s2) (v_of lca))));
  ...
  do_prop (concrete_merge (v_of lca) (v_of s1) (v_of s2')) last2;
  assume (forall e. (L.mem e (concrete_merge (v_of lca) (v_of s1) (v_of s2')) \/ e = (fst last2, get_ele last2)) <==>
                L.mem e (do (concrete_merge (v_of lca) (v_of s1) (v_of s2')) last2));
...
let ind_case_last1_neq_c2_last1_add_neq (lca s1 s2:st)
  : Lemma (requires (Seq.length (ops_of s1) > Seq.length (ops_of lca) /\
                    (let s1' = inverse_st s1 in
                    common_pre1 lca s1 s2 /\
                    (let s2' = inverse_st s2 in
  ...
  assume (forall e. L.mem e (v_of s1) <==> L.mem e (v_of s1') \/ e = (fst last1, get_ele last1)); 
  ...
  (*assert (forall e. (L.mem e (concrete_merge (v_of lca) (v_of s1) (v_of s2))) <==>
               (L.mem e (concrete_merge (v_of lca) (v_of s1) (v_of s2')) \/ e = (fst last2, get_ele last2))); admit(); //todo
...
let ind_case_last1_neq_c2_last1_add_eq (lca s1 s2:st)
  : Lemma (requires (Seq.length (ops_of s1) > Seq.length (ops_of lca) /\
                    (let s1' = inverse_st s1 in
                    common_pre1 lca s1 s2 /\
                    (let s2' = inverse_st s2 in
 ...
 : Lemma (requires common_pre1 lca s1 s2 /\ 
   ...
   if ops_of s1 = ops_of lca then
     ...
     (assume ((length (ops_of s1) > length (ops_of lca)));
      let _, last1 = un_snoc (ops_of s1) in
      assume (~ (Rem? (snd last1) /\ get_ele last1 = get_ele last2)); //todo
      let s1' = inverse_st s1 in
