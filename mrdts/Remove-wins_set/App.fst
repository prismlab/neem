...
type concrete_st = s:(S.t nat & S.t nat)
...
let do (s:concrete_st) (o:op_t) : concrete_st =
 match o with
  |(_, (rid, Add e)) -> (S.add e (fst s), snd s)
  |(_, (rid, Rem e)) -> (fst s, S.add e (snd s))
...
let merge_pre (l a b:concrete_st) =
  S.subset (fst l) (fst a) /\ S.subset (snd l) (snd a) /\
  S.subset (fst l) (fst b) /\ S.subset (snd l) (snd b)
