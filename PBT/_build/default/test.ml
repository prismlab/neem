...
let tests = "Test suite for MRDT" >::: [
  ...
  "print_res" >:: (fun _ -> Printf.printf "\nLin result = ";
                            print_orset (apply_events (List.rev (test_config.l(test_config.h(0)))));
                            Printf.printf "\nState = ";
                            print_orset (test_config.n (test_config.h 0)));
  ...
  "test_lin" >:: (fun _ -> assert (Orset.equal (apply_events (List.rev (test_config.l(test_config.h(0))))) (test_config.n (test_config.h 0))));
]
