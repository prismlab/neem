...
type concrete_st = (S.t (nat & nat) & S.t (nat & nat)) (* pair of observed and removed set *)
...
let do (s:concrete_st) (o:op_t) : concrete_st = 
  match o with
  |ts, (_, Add e) -> S.add (e, ts) (fst s), snd s
  |ts, (_, Rem e) -> fst s, S.union (snd s) (S.filter (fst s) (fun (e1,_) -> e1 = e))
