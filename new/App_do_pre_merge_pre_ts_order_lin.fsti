...
val do_pre_s (st_s:concrete_st_s) (_:op_t) : prop

// apply an operation to a state 
val do_s (st_s:concrete_st_s) (o:op_t{do_pre_s st_s o}) : concrete_st_s
...
val do_eq (st_s:concrete_st_s) (st:concrete_st) (op:op_t)
  : Lemma (requires do_pre st op /\ do_pre_s st_s op /\ eq_sm st_s st /\ do_pre st op)
          (ensures eq_sm (do_s st_s op) (do st op))

////////////////////////////////////////////////////////////////
//// Linearization properties //////

val conv_prop1 (lca s1 s2:concrete_st) (op1 op2:op_t)
...
val conv_prop2 (lca s1 s2:concrete_st) (op1 op2:op_t)
  : Lemma (requires do_pre s1 op1 /\ do_pre s2 op2 /\
...
val conv_prop3 (s:concrete_st)
  : Lemma (requires merge_pre s s s)
          (ensures eq (concrete_merge s s s) s) 
  
val conv_prop4 (lca s1 s2:concrete_st) (op:op_t)
