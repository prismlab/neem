...
let resolve_conflict (x:op_t) (y:op_t{fst x <> fst y}) : resolve_conflict_res =
  if get_ele x = get_ele y && Add? (snd x) && Rem? (snd y) then 
    First_then_second //y.x
  else Second_then_first //x.y
...
let prop1 (l:concrete_st) (o1 o2 o3:op_t)
  : Lemma (requires fst o1 <> fst o3 /\ ~ (mem_id_s (fst o2) l) /\
                    resolve_conflict o1 o3 = First_then_second) //o3.o1
          (ensures eq (do (do (do l o3) o1) o2)
                      (concrete_merge (do l o1) (do (do l o1) o2) (do (do l o3) o1))) = ()
...
let prop3 (a b c d:concrete_st) (o2 o2':op_t)
  : Lemma (requires fst o2 <> fst o2' /\
                    eq (concrete_merge a b c) d /\
                    eq (concrete_merge a (do b o2') c) (do d o2'))
          (ensures eq (concrete_merge a (do (do b o2') o2) c) (do (do d o2') o2)) = ()
...
let prop9 (l a b c:concrete_st) (o1 o3:op_t)
  : Lemma (requires fst o1 <> fst o3 /\
                    resolve_conflict o1 o3 = Second_then_first /\
                    get_ele o1 <> get_ele o3 /\
                    (forall x. eq (do (do x o1) o3) (concrete_merge x (do x o1) (do x o3))) /\
                    //eq (concrete_merge (do l o1) b (do a o1)) c /\
                    eq (concrete_merge l (do l o1) a) (do a o1) /\
                    eq (concrete_merge a (do a o1) (do a o3)) (concrete_merge l (do l o1) (do a o3)))
          (ensures eq (concrete_merge (do l o1) b (do (do a o1) o3)) (do c o3)) =  admit()

let prop4 (l s:concrete_st) (o1 o2 o3:op_t)
  : Lemma (requires fst o1 <> fst o3 /\ fst o2 <> fst o3 /\ fst o2 <> fst o3 /\
                    resolve_conflict o1 o3 = First_then_second /\
                    resolve_conflict o2 o3 = First_then_second /\
                    (forall x. eq (concrete_merge x (do x o2) (do x o3)) (do (do x o3) o2)) /\
                    (forall x. eq (concrete_merge x (do x o1) (do x o3)) (do (do x o3) o1)) /\
                    eq (concrete_merge l (do l o1) (do s o3)) (do (do s o3) o1) /\
                    eq (concrete_merge l (do (do l o1) o2) s) (do (do s o1) o2))
          (ensures eq (concrete_merge l (do (do l o1) o2) (do s o3)) (do (do (do s o3) o1) o2)) = admit()

let test (s:concrete_st) (o1 o2:op_t)
  : Lemma (requires fst o1 <> fst o2 /\ resolve_conflict o1 o2 = First_then_second
                     /\ ~ (mem_id_s (fst o1) s))
          (ensures eq (concrete_merge s (do s o1) (do s o2)) (do (do s o2) o1)) = ()

let prop8 (a b c d e l:concrete_st) (o1 o3:op_t)
  : Lemma (requires fst o1 <> fst o3 /\ resolve_conflict o1 o3 = First_then_second /\
                    eq (concrete_merge (do l o1) c e) b /\
                    (eq (concrete_merge l (do l o1) (do l o3)) (do (do l o3) o1)) /\
                    (forall x. eq (concrete_merge x (do x o1) (do x o3)) (do (do x o3) o1)))
          (ensures eq (concrete_merge (do l o1) c (do (do a o3) o1)) d) = admit()

let test1 (l a b c d e:concrete_st) (o2:op_t)
  : Lemma (requires eq (concrete_merge d b e) a /\
                    
                    eq (concrete_merge l d c) b /\
                    eq (concrete_merge l c e) a)
          (ensures eq (concrete_merge d b (do e o2)) (do a o2)) = ()

let prop10' (l a b c s:concrete_st) (o2 o3:op_t)
  : Lemma (requires eq (concrete_merge l (do l o2) (do l o3)) (do (do l o3) o2) /\
                    eq (concrete_merge l a (do l o3)) c /\
                    eq (concrete_merge a b c) s)
          (ensures eq (concrete_merge a (do b o2) c) (do s o2)) = ()
  
let prop10 (l a b c s:concrete_st) (o2 o3:op_t)
  : Lemma (requires fst o2 <> fst o3 /\ resolve_conflict o2 o3 = First_then_second /\
                    //eq (concrete_merge l (do l o2) (do l o3)) (do (do l o3) o2) /\
                    //(forall (x:concrete_st). eq (concrete_merge x (do x o2) (do x o3)) (do (do x o3) o2) ) /\
                    (forall x. eq (concrete_merge x (do x o2) (do x o3)) (do (do x o3) o2)) /\
                    //~ (mem_id_s (fst o2) l) /\
                    //Add? (snd o2) /\ Rem? (snd o3) /\ get_ele o2 <> get_ele o3 /\
                    //eq (concrete_merge a b c) s /\
                    eq (concrete_merge l a (do l o3)) c /\
                    //eq (concrete_merge l b (do l o3)) s /\
                    eq (concrete_merge a b c) s)
          (ensures eq (concrete_merge a (do b o2) c) (do s o2)) = 
  //assert (eq (concrete_merge l (do l o2) (do l o3)) (do (do l o3) o2));
  prop10' l a b c s o2 o3

let prop11' (l a b c s:concrete_st) (o2 o3:op_t)
  : Lemma (requires eq (concrete_merge l (do l o2) (do l o3)) (do (do l o2) o3) /\
                    eq (concrete_merge l a (do l o3)) c /\
                    eq (concrete_merge a b c) (do b o3))
          (ensures eq (concrete_merge a (do b o2) c) (do (do b o2) o3)) = admit()

#push-options "--z3rlimit 100"
let prop11 (l a b c s:concrete_st) (o2 o3:op_t)
  : Lemma (requires fst o2 <> fst o3 /\ resolve_conflict o2 o3 = Second_then_first /\
                    //Rem? (snd o2) /\ Add? (snd o3) /\
                    (forall x. eq (concrete_merge x (do x o2) (do x o3)) (do (do x o2) o3)) /\
                    eq (concrete_merge l (do l o2) (do l o3)) (do (do l o2) o3) /\
                    eq (concrete_merge l a (do l o3)) c /\
                    eq (concrete_merge a b c) (do b o3))
          (ensures eq (concrete_merge a (do b o2) c) (do (do b o2) o3)) = 
  //assert (eq (concrete_merge l (do l o2) (do l o3)) (do (do l o2) o3));
  () //prop11' l a b c s o2 o3
