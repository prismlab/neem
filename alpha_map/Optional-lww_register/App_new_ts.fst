...
let rc_ind_left_l (l a b:concrete_st_l) (o1 o1' o2:(nat & (nat & op_l)))
...
let rc_ind_left_e (l a b:concrete_st_e) (o1 o1' o2:(nat & (nat & op_e)))
  : Lemma (requires fst o1 =!= fst o2 /\ Fst_then_snd? (rc_e o1 o2) /\
...
let rc_ind_left (l a b:concrete_st) (o1 o1' o2:op_t)
  ...
  rc_ind_left_l (fst l) (fst a) (fst b) (get_op_l o1) (get_op_l o1') (get_op_l o2);
  rc_ind_left_e (snd l) (snd a) (snd b) (get_op_e o1) (get_op_e o1') (get_op_e o2)
...
let rc_inter_base_right_l (l s1 s2 s3:concrete_st_l) (ob ol o1 o2:(nat & (nat & op_l))) 
...
let rc_inter_base_right_e1 (l s1 s2 s3:concrete_st_e) (ob ol o1 o2:(nat & (nat & op_e))) 
  : Lemma (requires fst ob =!= fst ol /\ Fst_then_snd? (rc_e ob ol) /\
               ...
               eq_e (merge_e (do_e l ol) (do_e (do_e s1 ol) o1) (do_e (do_e s2 ol) o2)) (do_e (do_e (do_e s3 ol) o1) o2) /\                 
                    eq_e (merge_e l (do_e s1 ol) (do_e s2 ob)) (do_e (do_e s3 ob) ol))
          (ensures eq_e (merge_e (do_e l ol) (do_e (do_e s1 ol) o1) (do_e (do_e (do_e s2 ob) ol) o2)) 
                        (do_e (do_e (do_e (do_e s3 ob) ol) o1) o2)) = ()

let rc_inter_base_right_e2 (l s1 s2 s3:concrete_st_e) (ob ol o1 o2:(nat & (nat & op_e))) 
  : Lemma (requires fst ob =!= fst ol /\ Enable? (snd (snd ob)) /\ Enable? (snd (snd ol)) /\
                    fst o1 =!= fst o2 /\ Fst_then_snd? (rc_e o1 o2) /\
                    eq_e (merge_e (do_e l ol) (do_e (do_e l ol) o1) (do_e (do_e (do_e l ob) ol) o2)) 
                         (do_e (do_e (do_e (do_e l ob) ol) o1) o2) /\ //EXTRA!!
                    eq_e (merge_e l (do_e s1 o1) (do_e s2 o2)) (do_e (do_e s3 o1) o2) /\
               eq_e (merge_e (do_e l ol) (do_e (do_e s1 ol) o1) (do_e (do_e s2 ol) o2)) (do_e (do_e (do_e s3 ol) o1) o2) /\                 
                    eq_e (merge_e l (do_e s1 ol) (do_e s2 ob)) (do_e (do_e s3 ob) ol))
          (ensures eq_e (merge_e (do_e l ol) (do_e (do_e s1 ol) o1) (do_e (do_e (do_e s2 ob) ol) o2)) 
...
let rc_inter_base_right' (l s1 s2 s3:concrete_st) (ob ol o1 o2:op_t) 
  : Lemma (requires distinct_ops ob ol /\ (Fst_then_snd? (rc ob ol) \/ (Ts_order? (rc ob ol) /\ fst ob < fst ol)) /\ 
                    ...
                    eq (merge (do l ol) (do (do l ol) o1) (do (do (do l ob) ol) o2)) (do (do (do (do l ob) ol) o1) o2) /\ //EXTRA!!
  ...
  rc_inter_base_right_l (fst l) (fst s1) (fst s2) (fst s3) (get_op_l ob) (get_op_l ol) (get_op_l o1) (get_op_l o2); 
  if Fst_then_snd? (rc ob ol) then
    rc_inter_base_right_e1 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e ob) (get_op_e ol) (get_op_e o1) (get_op_e o2)
  else rc_inter_base_right_e2 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e ob) (get_op_e ol) (get_op_e o1) (get_op_e o2)

let rc_inter_base_left_l (l s1 s2 s3:concrete_st_l) (ob ol o1 o2:(nat & (nat & op_l))) 
  : Lemma (requires eq_l (merge_l (do_l l ol) (do_l (do_l s1 ol) o1) (do_l (do_l s2 ol) o2)) (do_l (do_l (do_l s3 ol) o1) o2))
...
let rc_inter_base_left' (l s1 s2 s3:concrete_st) (ob ol o1 o2:op_t) 
  ...
  rc_inter_base_left_l (fst l) (fst s1) (fst s2) (fst s3) (get_op_l ob) (get_op_l ol) (get_op_l o1) (get_op_l o2); 
  if Fst_then_snd? (rc ob ol) then
    rc_inter_base_left_e1 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e ob) (get_op_e ol) (get_op_e o1) (get_op_e o2)
  else rc_inter_base_left_e2 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e ob) (get_op_e ol) (get_op_e o1) (get_op_e o2)

let rc_inter_right_l (l s1 s2 s3:concrete_st_l) (o1 o2 ob ol o:(nat & (nat & op_l)))
...
let rc_inter_right_e1 (l s1 s2 s3:concrete_st_e) (o1 o2 ob ol o:(nat & (nat & op_e)))
  : Lemma (requires fst ob =!= fst ol /\ Fst_then_snd? (rc_e ob ol) /\
                    fst o1 =!= fst o2 /\ Fst_then_snd? (rc_e o1 o2) /\
                    get_rid o <> get_rid ol (*o,ol must be concurrent*) /\
                    //((~ (commutes_with_s o ob)) \/ Fst_then_snd? (rc_e o ol) \/ (Ts_order? (rc_e o ol) /\ fst o < fst ol)) /\
...
let rc_inter_right_e2 (l s1 s2 s3:concrete_st_e) (o1 o2 ob ol o:(nat & (nat & op_e)))
  : Lemma (requires fst ob =!= fst ol /\ Enable? (snd (snd ob)) /\ Enable? (snd (snd ol)) /\
                    fst o1 =!= fst o2 /\ Fst_then_snd? (rc_e o1 o2) /\
                    get_rid o <> get_rid ol (*o,ol must be concurrent*) /\
                    ...
                    eq_e (merge_e (do_e l ol) (do_e (do_e l ol) o1) (do_e (do_e (do_e (do_e l o) ob) ol) o2))
                         (do_e (do_e (do_e (do_e (do_e l o) ob) ol) o1) o2) /\ //EXTRA!!
                    eq_e (merge_e (do_e l ol) (do_e (do_e s1 ol) o1) (do_e (do_e (do_e s2 ob) ol) o2)) 
                         (do_e (do_e (do_e (do_e s3 ob) ol) o1) o2))
  (ensures eq_e (merge_e (do_e l ol) (do_e (do_e s1 ol) o1) (do_e (do_e (do_e (do_e s2 o) ob) ol) o2))
                (do_e (do_e (do_e (do_e (do_e s3 o) ob) ol) o1) o2)) = () 
...
let rc_inter_right' (l s1 s2 s3:concrete_st) (o1 o2 ob ol o:op_t)
  ...
  rc_inter_right_l (fst l) (fst s1) (fst s2) (fst s3) (get_op_l o1) (get_op_l o2) (get_op_l ob) (get_op_l ol) (get_op_l o); 
  if Fst_then_snd? (rc ob ol) then
    rc_inter_right_e1 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e o1) (get_op_e o2) (get_op_e ob) (get_op_e ol) (get_op_e o)  
  else rc_inter_right_e2 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e o1) (get_op_e o2) (get_op_e ob) (get_op_e ol) (get_op_e o)

let rc_inter_left_l (l s1 s2 s3:concrete_st_l) (o1 o2 ob ol o:(nat & (nat & op_l)))
...
let rc_inter_left_e1 (l s1 s2 s3:concrete_st_e) (o1 o2 ob ol o:(nat & (nat & op_e)))
  : Lemma (requires fst ob =!= fst ol /\ Fst_then_snd? (rc_e ob ol) /\
                    fst o1 =!= fst o2 /\ Fst_then_snd? (rc_e o1 o2) /\
                    get_rid o <> get_rid ol (*o,ol must be concurrent*) /\
                    //((~ (commutes_with_s o ob)) \/ Fst_then_snd? (rc_e o ol) \/ (Ts_order? (rc_e o ol) /\ fst o < fst ol)) /\
...
let rc_inter_left_e2 (l s1 s2 s3:concrete_st_e) (o1 o2 ob ol o:(nat & (nat & op_e)))
  : Lemma (requires fst ob =!= fst ol /\ Enable? (snd (snd ob)) /\ Enable? (snd (snd ol)) /\
                    fst o1 =!= fst o2 /\ Fst_then_snd? (rc_e o1 o2) /\
                    get_rid o <> get_rid ol (*o,ol must be concurrent*) /\
                    (((Disable? (snd (snd o)) /\ Enable? (snd (snd ob))) \/ (Enable? (snd (snd o)) /\ Disable? (snd (snd ob))) \/
                      (Enable? (snd (snd o)) /\ Enable? (snd (snd ob)))) \/
                      Fst_then_snd? (rc_e o ol) \/ (Enable? (snd (snd o)) /\ Enable? (snd (snd ol)) /\ fst o < fst ol)) /\
                    eq_e (merge_e (do_e l ol) (do_e (do_e (do_e (do_e l o) ob) ol) o1) (do_e (do_e l ol) o2))
                         (do_e (do_e (do_e (do_e (do_e l o) ob) ol) o1) o2) /\ //EXTRA!!
                    eq_e (merge_e (do_e l ol) (do_e (do_e (do_e s1 ob) ol) o1) (do_e (do_e s2 ol) o2)) 
                         (do_e (do_e (do_e (do_e s3 ob) ol) o1) o2))
  (ensures eq_e (merge_e (do_e l ol) (do_e (do_e (do_e (do_e s1 o) ob) ol) o1) (do_e (do_e s2 ol) o2))
...
let rc_inter_left' (l s1 s2 s3:concrete_st) (o1 o2 ob ol o:op_t)
  : Lemma (requires distinct_ops o1 o2 /\ Fst_then_snd? (rc o1 o2) /\  
                    distinct_ops ob ol /\ (Fst_then_snd? (rc ob ol) \/ (Ts_order? (rc ob ol) /\ fst ob < fst ol)) /\ 
          eq (merge (do l ol) (do (do (do (do l o) ob) ol) o1) (do (do l ol) o2)) (do (do (do (do (do l o) ob) ol) o1) o2) /\ //EXTRA!!
                    get_rid o <> get_rid ol (*o,ol must be concurrent*) /\
                    ((~ (commutes_with o ob)) \/ Fst_then_snd? (rc o ol) \/ (Ts_order? (rc o ol) /\ fst o < fst ol)) /\
  ...
  rc_inter_left_l (fst l) (fst s1) (fst s2) (fst s3) (get_op_l o1) (get_op_l o2) (get_op_l ob) (get_op_l ol) (get_op_l o); 
  if Fst_then_snd? (rc ob ol) then
    rc_inter_left_e1 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e o1) (get_op_e o2) (get_op_e ob) (get_op_e ol) (get_op_e o)  
  else rc_inter_left_e2 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e o1) (get_op_e o2) (get_op_e ob) (get_op_e ol) (get_op_e o)
...
let ts_inter_base_right_e1 (l s1 s2 s3:concrete_st_e) (ob ol o1 o2:(nat & (nat & op_e))) 
  : Lemma (requires Fst_then_snd? (rc_e ob ol) /\ Enable? (snd (snd o1)) /\ Enable? (snd (snd o2)) /\
                    ...
                    eq_e (merge_e (do_e l ol) (do_e s1 ol) (do_e (do_e s2 ob) ol)) (do_e (do_e s3 ob) ol) /\ //EXTRA!! comes from intermediate_base_zero_op
                    eq_e (merge_e l (do_e s1 o1) (do_e s2 o2)) (do_e (do_e s3 o1) o2) /\
                    eq_e (merge_e (do_e l ol) (do_e (do_e s1 ol) o1) (do_e (do_e s2 ol) o2)) (do_e (do_e (do_e s3 ol) o1) o2) /\
...
let ts_inter_base_right' (l s1 s2 s3:concrete_st) (ob ol o1 o2:op_t) 
  : Lemma (requires distinct_ops ob ol /\ (Fst_then_snd? (rc ob ol) \/ (Ts_order? (rc ob ol) /\ fst ob < fst ol)) /\ 
                    ...
                    (Fst_then_snd? (rc ob ol) ==> eq (merge (do l ol) (do s1 ol) (do (do s2 ob) ol)) (do (do s3 ob) ol)) /\ //EXTRA!! comes from intermediate_base_zero_op
                    eq (merge l (do s1 o1) (do s2 o2)) (do (do s3 o1) o2) /\
                    eq (merge (do l ol) (do (do s1 ol) o1) (do (do s2 ol) o2)) (do (do (do s3 ol) o1) o2) /\
                    eq (merge l (do s1 ol) (do s2 ob)) (do (do s3 ob) ol)) //***EXTRA***
          (ensures eq (merge (do l ol) (do (do s1 ol) o1) (do (do (do s2 ob) ol) o2)) (do (do (do (do s3 ob) ol) o1) o2)) = 
  ts_inter_base_right_l (fst l) (fst s1) (fst s2) (fst s3) (get_op_l ob) (get_op_l ol) (get_op_l o1) (get_op_l o2);
  if Fst_then_snd? (rc ob ol) then
    ts_inter_base_right_e1 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e ob) (get_op_e ol) (get_op_e o1) (get_op_e o2)
  else ts_inter_base_right_e2 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e ob) (get_op_e ol) (get_op_e o1) (get_op_e o2)
...
let ts_inter_base_left' (l s1 s2 s3:concrete_st) (ob ol o1 o2:op_t) 
  : Lemma (requires distinct_ops ob ol /\ (Fst_then_snd? (rc ob ol) \/ (Ts_order? (rc ob ol) /\ fst ob < fst ol)) /\ 
                    distinct_ops o1 o2 /\ Ts_order? (rc o1 o2) /\ fst o1 < fst o2 /\
                    eq (merge l (do (do s1 ob) o1) (do s2 o2)) (do (do (merge l (do s1 ob) s2) o2) o1) /\ //EXTRA!! comes from comm_ind_right
                    (Fst_then_snd? (rc ob ol) ==> eq (merge (do l ol) (do s1 ol) (do (do s2 ob) ol)) (do (do s3 ob) ol)) /\ //EXTRA!! comes from intermediate_base_zero_op
          ...
          (ensures eq (merge (do l ol) (do (do (do s1 ob) ol) o1) (do (do s2 ol) o2)) (do (do (do (do s3 ob) ol) o1) o2)) = 
  ts_inter_base_left_l (fst l) (fst s1) (fst s2) (fst s3) (get_op_l ob) (get_op_l ol) (get_op_l o1) (get_op_l o2);
  if Fst_then_snd? (rc ob ol) then
    ts_inter_base_left_e1 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e ob) (get_op_e ol) (get_op_e o1) (get_op_e o2)
  else ts_inter_base_left_e2 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e ob) (get_op_e ol) (get_op_e o1) (get_op_e o2)
...
let ts_inter_right' (l s1 s2 s3:concrete_st) (o1 o2 ob ol o:op_t)
  : Lemma (requires distinct_ops o1 o2 /\ Ts_order? (rc o1 o2) /\ fst o1 < fst o2 /\
                    ...
                    eq (merge (do l ol) (do (do s1 ol) o1) (do (do (do s2 ob) ol) o2)) (do (do (do (do s3 ob) ol) o1) o2))
      (ensures eq (merge (do l ol) (do (do s1 ol) o1) (do (do (do (do s2 o) ob) ol) o2)) (do (do (do (do (do s3 o) ob) ol) o1) o2)) =
  ts_inter_right_l (fst l) (fst s1) (fst s2) (fst s3) (get_op_l o1) (get_op_l o2) (get_op_l ob) (get_op_l ol) (get_op_l o);
  if Fst_then_snd? (rc ob ol) then
    ts_inter_right_e1 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e o1) (get_op_e o2) (get_op_e ob) (get_op_e ol) (get_op_e o)
  else admit()
...
let ts_inter_left' (l s1 s2 s3:concrete_st) (o1 o2 ob ol o:op_t)
  : Lemma (requires distinct_ops o1 o2 /\ Ts_order? (rc o1 o2) /\ fst o1 < fst o2 /\ 
                    ...
                    eq (merge (do l ol) (do (do (do s1 ob) ol) o1) (do (do s2 ol) o2)) (do (do (do (do s3 ob) ol) o1) o2))
      (ensures eq (merge (do l ol) (do (do (do (do s1 o) ob) ol) o1) (do (do s2 ol) o2)) (do (do (do (do (do s3 o) ob) ol) o1) o2)) =
  ts_inter_left_l (fst l) (fst s1) (fst s2) (fst s3) (get_op_l o1) (get_op_l o2) (get_op_l ob) (get_op_l ol) (get_op_l o);
  if Fst_then_snd? (rc ob ol) then
    ts_inter_left_e1 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e o1) (get_op_e o2) (get_op_e ob) (get_op_e ol) (get_op_e o)
  else admit()
...
let one_op_inter_right_e1 (l s1 s2 s3:concrete_st_e) (o1 ob ol o:(nat & (nat & op_e)))
  : Lemma (requires Fst_then_snd? (rc_e ob ol) /\
                    (((Disable? (snd (snd o)) /\ Enable? (snd (snd ob))) \/ (Enable? (snd (snd o)) /\ Disable? (snd (snd ob))) \/
                      (Enable? (snd (snd o)) /\ Enable? (snd (snd ob)))) \/
                      Fst_then_snd? (rc_e o ol) \/ (Enable? (snd (snd o)) /\ Enable? (snd (snd ol)) /\ fst o < fst ol)) /\
                    eq_e (merge_e (do_e l ol) (do_e (do_e l ol) o1) (do_e (do_e (do_e l o) ob) ol) ) 
                         (do_e (do_e (do_e (do_e l o) ob) ol) o1) /\ //EXTRA!!
                    eq_e (merge_e (do_e l ol) (do_e (do_e s1 ol) o1) (do_e (do_e s2 ob) ol)) (do_e (do_e (do_e s3 ob) ol)o1))               
          (ensures eq_e (merge_e (do_e l ol) (do_e (do_e s1 ol) o1) (do_e (do_e (do_e s2 o) ob) ol) ) 
                        (do_e (do_e (do_e (do_e s3 o) ob) ol) o1)) = ()

let one_op_inter_right_e2 (l s1 s2 s3:concrete_st_e) (o1 ob ol o:(nat & (nat & op_e)))
  : Lemma (requires Enable? (snd (snd ob)) /\ Enable? (snd (snd ol)) /\
                    ...
                    eq_e (merge_e (do_e l ol) (do_e (do_e s1 ol) o1) (do_e (do_e s2 ob) ol)) (do_e (do_e (do_e s3 ob) ol)o1))               
          (ensures eq_e (merge_e (do_e l ol) (do_e (do_e s1 ol) o1) (do_e (do_e (do_e s2 o) ob) ol) ) 
                        (do_e (do_e (do_e (do_e s3 o) ob) ol) o1)) = admit()
                        
let one_op_inter_right' (l s1 s2 s3:concrete_st) (o1 ob ol o:op_t)
  : Lemma (requires distinct_ops ob ol /\ (Fst_then_snd? (rc ob ol) \/ (Ts_order? (rc ob ol) /\ fst ob < fst ol)) /\ 
                    get_rid o <> get_rid ol (*o,ol must be concurrent*) /\
                    ((~ (commutes_with o ob)) \/ Fst_then_snd? (rc o ol) \/ (Ts_order? (rc o ol) /\ fst o < fst ol)) /\
                    eq (merge (do l ol) (do (do l ol) o1) (do (do (do l o) ob) ol)) (do (do (do (do l o) ob) ol) o1) /\ //EXTRA!!
  ...
  if Fst_then_snd? (rc ob ol) then
    one_op_inter_right_e1 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e o1) (get_op_e ob) (get_op_e ol) (get_op_e o)
  else one_op_inter_right_e2 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e o1) (get_op_e ob) (get_op_e ol) (get_op_e o)

let one_op_inter_left_e1 (l s1 s2 s3:concrete_st_e) (o1 ob ol o:(nat & (nat & op_e)))
  : Lemma (requires Fst_then_snd? (rc_e ob ol) /\
                    (((Disable? (snd (snd o)) /\ Enable? (snd (snd ob))) \/ (Enable? (snd (snd o)) /\ Disable? (snd (snd ob))) \/
                      (Enable? (snd (snd o)) /\ Enable? (snd (snd ob)))) \/
                      Fst_then_snd? (rc_e o ol) \/ (Enable? (snd (snd o)) /\ Enable? (snd (snd ol)) /\ fst o < fst ol)) /\
                    eq_e (merge_e (do_e l ol) (do_e (do_e (do_e l o) ob) ol) (do_e (do_e l ol) o1))
                         (do_e (do_e (do_e (do_e l o) ob) ol) o1) /\ //EXTRA!!
                    eq_e (merge_e (do_e l ol) (do_e (do_e s1 ob) ol) (do_e (do_e s2 ol) o1)) (do_e (do_e (do_e s3 ob) ol) o1))            
          (ensures eq_e (merge_e (do_e l ol) (do_e (do_e (do_e s1 o) ob) ol) (do_e (do_e s2 ol) o1)) 
                        (do_e (do_e (do_e (do_e s3 o) ob) ol) o1)) = ()

let one_op_inter_left_e2 (l s1 s2 s3:concrete_st_e) (o1 ob ol o:(nat & (nat & op_e)))
  : Lemma (requires Enable? (snd (snd ob)) /\ Enable? (snd (snd ol)) /\
                    (((Disable? (snd (snd o)) /\ Enable? (snd (snd ob))) \/ (Enable? (snd (snd o)) /\ Disable? (snd (snd ob))) \/
                      (Enable? (snd (snd o)) /\ Enable? (snd (snd ob)))) \/
                      Fst_then_snd? (rc_e o ol) \/ (Enable? (snd (snd o)) /\ Enable? (snd (snd ol)) /\ fst o < fst ol)) /\
...
let one_op_inter_left' (l s1 s2 s3:concrete_st) (o1 ob ol o:op_t)
  : Lemma (requires distinct_ops ob ol /\ (Fst_then_snd? (rc ob ol) \/ (Ts_order? (rc ob ol) /\ fst ob < fst ol)) /\ 
                    get_rid o <> get_rid ol (*o,ol must be concurrent*) /\
                    ((~ (commutes_with o ob)) \/ Fst_then_snd? (rc o ol) \/ (Ts_order? (rc o ol) /\ fst o < fst ol)) /\
                    eq (merge (do l ol) (do (do (do l o) ob) ol) (do (do l ol) o1)) (do (do (do (do l o) ob) ol) o1) /\ //EXTRA!!
  ...
  if Fst_then_snd? (rc ob ol) then
    one_op_inter_left_e1 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e o1) (get_op_e ob) (get_op_e ol) (get_op_e o)
  else one_op_inter_left_e2 (snd l) (snd s1) (snd s2) (snd s3) (get_op_e o1) (get_op_e ob) (get_op_e ol) (get_op_e o)
