...
// concrete state of value MRDT (Grow-only set)
let concrete_st_v = S.t (pos & nat) // (timestamp, ele) //timestamps are unique
...
type app_op_v : eqtype =
  ...
  |Rem : nat (*value*) -> app_op_v

let get_ele (o:op_v) : nat =
...
let rc_non_comm_help1 (o1 o2:op_t)
  : Lemma (requires distinct_ops o1 o2)
          (ensures (Add? (snd (snd (get_op_v o1))) /\ Rem? (snd (snd (get_op_v o2))) /\ get_ele (get_op_v o1) = get_ele (get_op_v o2) /\ get_key o1 = get_key o2) ==> 
                           ~ (eq (do (do init_st o1) o2) (do (do init_st o2) o1))) = ()

let rc_non_comm_help2 (o1 o2:op_t)
  : Lemma (requires distinct_ops o1 o2)
          (ensures (Rem? (snd (snd (get_op_v o1))) /\ Add? (snd (snd (get_op_v o2))) /\ get_ele (get_op_v o1) = get_ele (get_op_v o2) /\ get_key o1 = get_key o2) ==> 
                          ~ (eq (do (do init_st o1) o2) (do (do init_st o2) o1))) = ()
...
let rc_inter_base_right_ne (l a b c:concrete_st) (o1 o2 ob ol:op_t) 
  : Lemma (requires Fst_then_snd? (rc o1 o2) /\ Fst_then_snd? (rc ob ol) /\ 
                    distinct_ops o1 o2 /\ distinct_ops o1 ob /\ distinct_ops o1 ol /\ distinct_ops o2 ob /\ distinct_ops o2 ol /\ distinct_ops ob ol /\ 
                    ~ (get_key o1 = get_key o2 /\ get_key o2 = get_key ob /\ Fst_then_snd? (rc_v (get_op_v o1) (get_op_v o2)) /\ Fst_then_snd? (rc_v (get_op_v ob) (get_op_v ol))) /\
