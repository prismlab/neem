...
//concrete state of gamma type
val concrete_st_c : Type0

let vt (c:kt) : Type0 =
  match c with
  |Alpha_t _ -> concrete_st_a
  |Beta_t _ -> concrete_st_b
  |Gamma_t _ -> concrete_st_c
...
//init state of gamma type
val init_st_c : concrete_st_c
...
let sel (s:concrete_st) (k:kt) =
  ...
  |Gamma_t _ -> if M.contains s k then M.sel s k else init_st_c

val eq_a (a b:concrete_st_a) : Type0
val eq_b (a b:concrete_st_b) : Type0
val eq_c (a b:concrete_st_c) : Type0
...
let eq (a b:concrete_st) =
  ...
  (forall k. M.contains a (Alpha_t k) = M.contains b (Alpha_t k) /\ 
        ...
        M.contains a (Gamma_t k) = M.contains b (Gamma_t k) /\
        eq_a (sel a (Alpha_t k)) (sel b (Alpha_t k)) /\
        eq_b (sel a (Beta_t k)) (sel b (Beta_t k)) /\
        eq_c (sel a (Gamma_t k)) (sel b (Gamma_t k)))
...
val lem_eq_c (a b:concrete_st_c) 
  : Lemma (ensures eq_c a b <==> a == b)
          [SMTPat (eq_c a b)]
...
type op_c = pos (*timestamp*) & (nat (*replica ID*) & app_op_c)
...
let is_gamma_op (o:op_t) = 
  match snd (snd o) with
  |Set _ (Gamma_op _) -> true
  |_ -> false
...
let get_op_c (o:op_t{is_gamma_op o}) : op_c =
  match o with
  |ts, (rid, Set _ (Gamma_op op)) -> (ts,(rid,op))
...
//do function of gamma type
val do_c (s:concrete_st_c) (o:op_c) : concrete_st_c
...
let do (s:concrete_st) (o:op_t) : concrete_st =
  ...
  |Set k (Gamma_op _) -> let v = sel s (Gamma_t k) in M.upd s (Gamma_t k) (do_c v (get_op_c o))
...
let rc (o1 o2:op_t) : rc_res = 
  ...
  |Set k1 (Gamma_op _), Set k2 (Gamma_op _) -> if k1 = k2 then rc_c (get_op_c o1) (get_op_c o2) else Either
  |_ -> Either
...
val merge_c (l a b:concrete_st_c) : concrete_st_c

let compose_values (k:kt) (l a b:concrete_st) : vt k =
  if Alpha_t? k then merge_a (sel l k) (sel a k) (sel b k)
  else if Beta_t? k then merge_b (sel l k) (sel a k) (sel b k)
  else merge_c (sel l k) (sel a k) (sel b k)
...
val merge_comm_c (l a b: concrete_st_c) 
  : Lemma (ensures eq_c (merge_c l a b) (merge_c l b a))
          [SMTPat (merge_c l a b)]
...
val merge_idem_c (s: concrete_st_c) 
  : Lemma (ensures eq_c (merge_c s s s) s)
          [SMTPat (merge_c s s s)]
...
val base_2op_c (o1 o2:op_c) 
  : Lemma (requires (Fst_then_snd? (rc_c o2 o1) \/ Either? (rc_c o2 o1)) /\ get_rid o1 <> get_rid o2 /\
                    distinct_ops o1 o2)
          (ensures eq_c (merge_c init_st_c (do_c init_st_c o1) (do_c init_st_c o2)) 
                        (do_c (merge_c init_st_c init_st_c (do_c init_st_c o2)) o1))
...
val base_2op' (o1 o2:op_t) (t:kt)
  : Lemma (requires Either? (rc o2 o1) /\ get_rid o1 <> get_rid o2 /\ distinct_ops o1 o2 /\
                    ~ (get_key o1 = get_key o2 /\ 
                       ...
                       is_gamma_op o1 /\ is_gamma_op o2 /\ (Fst_then_snd? (rc_c (get_op_c o2) (get_op_c o1)) || Either? (rc_c (get_op_c o2) (get_op_c o1)))))
...
let base_2op (o1 o2:op_t) (t:kt)
  ...
  else if get_key o1 = get_key o2 && is_gamma_op o1 && is_gamma_op o2 then
    base_2op_c (get_op_c o1) (get_op_c o2) 
...
val ind_lca_2op_c (l:concrete_st_c) (o1 o2 ol:op_c)
  : Lemma (requires (Fst_then_snd? (rc_c o2 o1) \/ Either? (rc_c o2 o1)) /\ get_rid o1 <> get_rid o2 /\
                    distinct_ops o1 o2 /\ distinct_ops o1 ol /\ distinct_ops o2 ol /\
                    eq_c (merge_c l (do_c l o1) (do_c l o2)) (do_c (merge_c l l (do_c l o2)) o1))
          (ensures eq_c (merge_c (do_c l ol) (do_c (do_c l ol) o1) (do_c (do_c l ol) o2)) (do_c (merge_c (do_c l ol) (do_c l ol) (do_c (do_c l ol) o2)) o1))
...
val ind_lca_2op' (l:concrete_st) (o1 o2 ol:op_t)
  : Lemma (requires Either? (rc o2 o1) /\ get_rid o1 <> get_rid o2 /\
                    ...
                    ~ (get_key o1 = get_key ol && get_key o2 = get_key ol /\
                       ...
                       is_gamma_op o1 /\ is_gamma_op o2 /\ is_gamma_op ol /\ (Fst_then_snd? (rc_c (get_op_c o2) (get_op_c o1)) || Either? (rc_c (get_op_c o2) (get_op_c o1)))) /\
...
let ind_lca_2op (l:concrete_st) (o1 o2 ol:op_t)
  : Lemma (requires (Fst_then_snd? (rc o2 o1) \/ Either? (rc o2 o1)) /\ get_rid o1 <> get_rid o2 /\
          ...
          (ensures eq (merge (do l ol) (do (do l ol) o1) (do (do l ol) o2)) (do (merge (do l ol) (do l ol) (do (do l ol) o2)) o1)) =
  let k = get_key ol in
  let ka = Alpha_t k in let kb = Beta_t k in let kc = Gamma_t k in 
  ...
  else if get_key o1 = k && get_key o2 = k && is_gamma_op o1 && is_gamma_op o2 && is_gamma_op ol && (Fst_then_snd? (rc_c (get_op_c o2) (get_op_c o1)) || Either? (rc_c (get_op_c o2) (get_op_c o1))) then
      ind_lca_2op_c (sel l kc) (get_op_c o1) (get_op_c o2) (get_op_c ol)
...
val inter_right_base_2op_c (l a b :concrete_st_c) (o1 o2 ob ol:op_c)
  : Lemma (requires (Fst_then_snd? (rc_c o2 o1) \/ Either? (rc_c o2 o1)) /\ get_rid o1 <> get_rid o2 /\ Fst_then_snd? (rc_c ob ol) /\ get_rid ob <> get_rid ol /\
                    distinct_ops o1 o2 /\ distinct_ops o1 ob /\ distinct_ops o1 ol /\ distinct_ops o2 ob /\ distinct_ops o2 ol /\ distinct_ops ob ol /\
                    eq_c (merge_c l (do_c a o1) (do_c b o2)) (do_c (merge_c l a (do_c b o2)) o1) /\ //from pre-cond of ind_right_2op
                    eq_c (merge_c l (do_c a o1) (do_c (do_c b ob) o2)) (do_c (merge_c l a (do_c (do_c b ob) o2)) o1) /\ //from ind_right_2op
                    eq_c (merge_c (do_c l ol) (do_c (do_c a ol) o1) (do_c (do_c b ol) o2)) (do_c (merge_c (do_c l ol) (do_c a ol) (do_c (do_c b ol) o2)) o1))
          (ensures eq_c (merge_c (do_c l ol) (do_c (do_c a ol) o1) (do_c (do_c (do_c b ob) ol) o2)) (do_c (merge_c (do_c l ol) (do_c a ol) (do_c (do_c (do_c b ob) ol) o2)) o1))
...
val inter_right_base_2op' (l a b :concrete_st) (o1 o2 ob ol:op_t)
  : Lemma (requires Either? (rc o2 o1) /\ get_rid o1 <> get_rid o2 /\ Fst_then_snd? (rc ob ol) /\ get_rid ob <> get_rid ol /\
                    ...
                    ~ (get_key o1 = get_key ol && get_key o2 = get_key ol /\ get_key ob = get_key ol /\
                       ...
                       is_gamma_op o1 /\ is_gamma_op o2 /\ is_gamma_op ob /\ is_gamma_op ol /\ (Fst_then_snd? (rc_c (get_op_c o2) (get_op_c o1)) || Either? (rc_c (get_op_c o2) (get_op_c o1))) /\ Fst_then_snd? (rc_c (get_op_c ob) (get_op_c ol))) /\
...
let inter_right_base_2op (l a b :concrete_st) (o1 o2 ob ol:op_t)
  ...
  else if get_key o1 = k && get_key o2 = k && get_key ob = k && is_gamma_op o1 && is_gamma_op o2 && is_gamma_op ob && is_gamma_op ol && (Fst_then_snd? (rc_c (get_op_c o2) (get_op_c o1)) || Either? (rc_c (get_op_c o2) (get_op_c o1))) && Fst_then_snd? (rc_c (get_op_c ob) (get_op_c ol)) then
      inter_right_base_2op_c (sel l kc) (sel a kc) (sel b kc) (get_op_c o1) (get_op_c o2) (get_op_c ob) (get_op_c ol)
...
val inter_left_base_2op_c (l a b :concrete_st_c) (o1 o2 ob ol:op_c)
  : Lemma (requires (Fst_then_snd? (rc_c o2 o1) \/ Either? (rc_c o2 o1)) /\ get_rid o1 <> get_rid o2 /\ Fst_then_snd? (rc_c ob ol) /\ get_rid ob <> get_rid ol /\
                    distinct_ops o1 o2 /\ distinct_ops o1 ob /\ distinct_ops o1 ol /\ distinct_ops o2 ob /\ distinct_ops o2 ol /\ distinct_ops ob ol /\
                    eq_c (merge_c (do_c l ol) (do_c (do_c a ol) o1) (do_c (do_c b ol) o2)) (do_c (merge_c (do_c l ol) (do_c a ol) (do_c (do_c b ol) o2)) o1))
          (ensures eq_c (merge_c (do_c l ol) (do_c (do_c (do_c a ob) ol) o1) (do_c (do_c b ol) o2)) (do_c (merge_c (do_c l ol) (do_c (do_c a ob) ol) (do_c (do_c b ol) o2)) o1))
...
let inter_left_base_2op (l a b :concrete_st) (o1 o2 ob ol:op_t)
  ...
  if get_key o1 = k && get_key o2 = k && get_key ob = k && is_alpha_op o1 && is_alpha_op o2 && is_alpha_op ob && is_alpha_op ol && (Fst_then_snd? (rc_a (get_op_a o2) (get_op_a o1)) || Either? (rc_a (get_op_a o2) (get_op_a o1))) && Fst_then_snd? (rc_a (get_op_a ob) (get_op_a ol)) then
      ...
      inter_left_base_2op_c (sel l kc) (sel a kc) (sel b kc) (get_op_c o1) (get_op_c o2) (get_op_c ob) (get_op_c ol)
...
val inter_right_2op_c (l a b :concrete_st_c) (o1 o2 ob ol o:op_c)
  : Lemma (requires (Fst_then_snd? (rc_c o2 o1) \/ Either? (rc_c o2 o1)) /\ get_rid o1 <> get_rid o2 /\ Fst_then_snd? (rc_c ob ol) /\ get_rid ob <> get_rid ol /\
                    (~ (Either? (rc_c o ob)) \/ Fst_then_snd? (rc_c o ol)) /\
                    distinct_ops o1 o2 /\ distinct_ops o1 ob /\ distinct_ops o1 ol /\ distinct_ops o1 o /\ distinct_ops o2 ob /\ distinct_ops o2 ol /\ distinct_ops o2 o /\ distinct_ops ob ol /\ distinct_ops ob o /\ distinct_ops ol o /\
                    get_rid o <> get_rid ol /\
                    eq_c (merge_c (do_c l ol) (do_c (do_c a ol) o1) (do_c (do_c (do_c b ob) ol) o2)) (do_c (merge_c (do_c l ol) (do_c a ol) (do_c (do_c (do_c b ob) ol) o2)) o1))
          (ensures eq_c (merge_c (do_c l ol) (do_c (do_c a ol) o1) (do_c (do_c (do_c (do_c b o) ob) ol) o2)) (do_c (merge_c (do_c l ol) (do_c a ol) (do_c (do_c (do_c (do_c b o) ob) ol) o2)) o1))
...
val inter_right_2op' (l a b :concrete_st) (o1 o2 ob ol o:op_t)
  : Lemma (requires Either? (rc o2 o1) /\ get_rid o1 <> get_rid o2 /\ Fst_then_snd? (rc ob ol) /\ get_rid ob <> get_rid ol /\
                    ...
                    ~ (get_key o1 = get_key o && get_key o2 = get_key o /\ get_key ob = get_key o /\ get_key ol = get_key o /\
                       ...
                       is_gamma_op o1 /\ is_gamma_op o2 /\ is_gamma_op ob /\ is_gamma_op ol /\ is_gamma_op o /\ (Fst_then_snd? (rc_c (get_op_c o2) (get_op_c o1)) \/ Either? (rc_c (get_op_c o2) (get_op_c o1))) /\ Fst_then_snd? (rc_c (get_op_c ob) (get_op_c ol)) /\ (Fst_then_snd? (rc_c (get_op_c o) (get_op_c ob)) \/ Snd_then_fst? (rc_c (get_op_c o) (get_op_c ob)) \/ Fst_then_snd? (rc_c (get_op_c o) (get_op_c ol)))) /\
...
let inter_right_2op (l a b :concrete_st) (o1 o2 ob ol o:op_t)
  ...
  else if get_key o1 = k && get_key o2 = k && get_key ob = k && get_key ol = k && is_gamma_op o1 && is_gamma_op o2 && is_gamma_op ob && is_gamma_op ol && is_gamma_op o && (Fst_then_snd? (rc_c (get_op_c o2) (get_op_c o1)) || Either? (rc_c (get_op_c o2) (get_op_c o1))) && Fst_then_snd? (rc_c (get_op_c ob) (get_op_c ol)) && (Fst_then_snd? (rc_c (get_op_c o) (get_op_c ob)) || Snd_then_fst? (rc_c (get_op_c o) (get_op_c ob)) || Fst_then_snd? (rc_c (get_op_c o) (get_op_c ol))) then
    inter_right_2op_c (sel l kc) (sel a kc) (sel b kc) (get_op_c o1) (get_op_c o2) (get_op_c ob) (get_op_c ol) (get_op_c o)
...
val inter_left_2op_c (l a b :concrete_st_c) (o1 o2 ob ol o:op_c)
  : Lemma (requires (Fst_then_snd? (rc_c o2 o1) \/ Either? (rc_c o2 o1)) /\ get_rid o1 <> get_rid o2 /\ Fst_then_snd? (rc_c ob ol) /\ get_rid ob <> get_rid ol /\
                    (~ (Either? (rc_c o ob)) \/ Fst_then_snd? (rc_c o ol)) /\
                    distinct_ops o1 o2 /\ distinct_ops o1 ob /\ distinct_ops o1 ol /\ distinct_ops o1 o /\ distinct_ops o2 ob /\ distinct_ops o2 ol /\ distinct_ops o2 o /\ distinct_ops ob ol /\ distinct_ops ob o /\ distinct_ops ol o /\
                    get_rid o <> get_rid ol /\
                    eq_c (merge_c (do_c l ol) (do_c (do_c (do_c a ob) ol) o1) (do_c (do_c b ol) o2)) (do_c (merge_c (do_c l ol) (do_c (do_c a ob) ol) (do_c (do_c b ol) o2)) o1))
          (ensures eq_c (merge_c (do_c l ol) (do_c (do_c (do_c (do_c a o) ob) ol) o1) (do_c (do_c b ol) o2)) (do_c (merge_c (do_c l ol) (do_c (do_c (do_c a o) ob) ol) (do_c (do_c b ol) o2)) o1))
...
let inter_left_2op (l a b :concrete_st) (o1 o2 ob ol o:op_t)
  ...
  if get_key o1 = k && get_key o2 = k && get_key ob = k && get_key ol = k && is_alpha_op o1 && is_alpha_op o2 && is_alpha_op ob && is_alpha_op ol && is_alpha_op o && (Fst_then_snd? (rc_a (get_op_a o2) (get_op_a o1)) || Either? (rc_a (get_op_a o2) (get_op_a o1))) && Fst_then_snd? (rc_a (get_op_a ob) (get_op_a ol)) && (Fst_then_snd? (rc_a (get_op_a o) (get_op_a ob)) || Snd_then_fst? (rc_a (get_op_a o) (get_op_a ob)) || Fst_then_snd? (rc_a (get_op_a o) (get_op_a ol))) then 
    ...
    inter_left_2op_c (sel l kc) (sel a kc) (sel b kc) (get_op_c o1) (get_op_c o2) (get_op_c ob) (get_op_c ol) (get_op_c o)
...
val ind_right_2op_c (l a b:concrete_st_c) (o1 o2 o2':op_c)
  : Lemma (requires Fst_then_snd? (rc_c o2 o1) /\ get_rid o1 <> get_rid o2 /\
                    distinct_ops o1 o2 /\ distinct_ops o1 o2' /\ distinct_ops o2 o2' /\
                    eq_c (merge_c l (do_c a o1) (do_c b o2)) (do_c (merge_c l a (do_c b o2)) o1))
          (ensures eq_c (merge_c l (do_c a o1) (do_c (do_c b o2') o2)) (do_c (merge_c l a (do_c (do_c b o2') o2)) o1))
...
let ind_right_2op (l a b:concrete_st) (o1 o2 o2':op_t)
  ...
  else if get_key o1 = k && get_key o2 = k && is_gamma_op o1 && is_gamma_op o2 && is_gamma_op o2' && Fst_then_snd? (rc_c (get_op_c o2) (get_op_c o1)) then
      ind_right_2op_c (sel l kc) (sel a kc) (sel b kc) (get_op_c o1) (get_op_c o2) (get_op_c o2')
  else ()
...
val ind_left_2op_c (l a b:concrete_st_c) (o1 o2 o1':op_c)
  : Lemma (requires Fst_then_snd? (rc_c o2 o1) /\ get_rid o1 <> get_rid o2 /\
                    distinct_ops o1 o2 /\ distinct_ops o1 o1' /\ distinct_ops o2 o1' /\
                    eq_c (merge_c l (do_c a o1) (do_c b o2)) (do_c (merge_c l a (do_c b o2)) o1))
          (ensures eq_c (merge_c l (do_c (do_c a o1') o1) (do_c b o2)) (do_c (merge_c l (do_c a o1') (do_c b o2)) o1))
...
let ind_left_2op (l a b:concrete_st) (o1 o2 o1':op_t)
  ...
  else if get_key o1 = k && get_key o2 = k && is_gamma_op o1 && is_gamma_op o2 && is_gamma_op o1' && Fst_then_snd? (rc_c (get_op_c o2) (get_op_c o1)) then
      ind_left_2op_c (sel l kc) (sel a kc) (sel b kc) (get_op_c o1) (get_op_c o2) (get_op_c o1')
  else ()
...
val base_1op_c (o1:op_c) 
  : Lemma (ensures eq_c (merge_c init_st_c (do_c init_st_c o1) init_st_c) (do_c (merge_c init_st_c init_st_c init_st_c) o1))
...
let base_1op (o1:op_t) (t:kt)
  ...
  else if is_gamma_op o1 then base_1op_c (get_op_c o1)
  else ()
...
val ind_lca_1op_c (l:concrete_st_c) (o1 ol:op_c)
  : Lemma (requires distinct_ops o1 ol /\ 
                    eq_c (merge_c l (do_c l o1) l) (do_c (merge_c l l l) o1))
          (ensures eq_c (merge_c (do_c l ol) (do_c (do_c l ol) o1) (do_c l ol)) (do_c (merge_c (do_c l ol) (do_c l ol) (do_c l ol)) o1))
...
let ind_lca_1op (l:concrete_st) (o1 ol:op_t)
  ...
  else if get_key o1 = k && is_gamma_op o1 && is_gamma_op ol then
      ind_lca_1op_c (sel l kc) (get_op_c o1) (get_op_c ol)
  else ()
...
val inter_right_base_1op_c (l a b :concrete_st_c) (o1 ob ol:op_c)
  : Lemma (requires Fst_then_snd? (rc_c ob ol) /\ get_rid ob <> get_rid ol /\
                    distinct_ops o1 ob /\ distinct_ops o1 ol /\ distinct_ops ob ol /\
                    (Fst_then_snd? (rc_c ob o1) ==> eq_c (merge_c l (do_c a o1) (do_c b ob)) (do_c (merge_c l a (do_c b ob)) o1)) /\ //from app.fsti
                    eq_c (merge_c (do_c l ol) (do_c (do_c a ol) o1) (do_c b ol)) (do_c (merge_c (do_c l ol) (do_c a ol) (do_c b ol)) o1))
          (ensures eq_c (merge_c (do_c l ol) (do_c (do_c a ol) o1) (do_c (do_c b ob) ol)) (do_c (merge_c (do_c l ol) (do_c a ol) (do_c (do_c b ob) ol)) o1))
...
let inter_right_base_1op (l a b :concrete_st) (o1 ob ol:op_t)
  ...
  else if get_key o1 = k && get_key ob = k && is_gamma_op o1 && is_gamma_op ob && is_gamma_op ol && Fst_then_snd? (rc_c (get_op_c ob) (get_op_c ol)) then
      inter_right_base_1op_c (sel l kc) (sel a kc) (sel b kc) (get_op_c o1) (get_op_c ob) (get_op_c ol)
  else ()
...
val inter_left_base_1op_c (l a b :concrete_st_c) (o1 ob ol:op_c)
  : Lemma (requires Fst_then_snd? (rc_c ob ol) /\ get_rid ob <> get_rid ol /\
                    distinct_ops o1 ob /\ distinct_ops o1 ol /\ distinct_ops ob ol /\
                    eq_c (merge_c (do_c l ol) (do_c (do_c a ol) o1) (do_c b ol)) (do_c (merge_c (do_c l ol) (do_c a ol) (do_c b ol)) o1))
          (ensures eq_c (merge_c (do_c l ol) (do_c (do_c (do_c a ob) ol) o1) (do_c b ol)) (do_c (merge_c (do_c l ol) (do_c (do_c a ob) ol) (do_c b ol)) o1))
...
let inter_left_base_1op (l a b:concrete_st) (o1 ob ol:op_t)
  ...
  if get_key o1 = k && get_key ob = k && is_alpha_op o1 && is_alpha_op ob && is_alpha_op ol && Fst_then_snd? (rc_a (get_op_a ob) (get_op_a ol)) then
      ...
      inter_left_base_1op_c (sel l kc) (sel a kc) (sel b kc) (get_op_c o1) (get_op_c ob) (get_op_c ol)
  else ()
...
val inter_right_1op_c (l a b :concrete_st_c) (o1 ob ol o:op_c)
  : Lemma (requires Fst_then_snd? (rc_c ob ol) /\ get_rid ob <> get_rid ol /\
                    (~ (Either? (rc_c o ob)) \/ Fst_then_snd? (rc_c o ol)) /\
                    distinct_ops o1 ob /\ distinct_ops o1 ol /\ distinct_ops o1 o /\ distinct_ops ob ol /\ distinct_ops ob o /\ distinct_ops ol o /\
                    get_rid o <> get_rid ol /\
                    eq_c (merge_c (do_c l ol) (do_c (do_c a ol) o1) (do_c (do_c b ob) ol)) (do_c (merge_c (do_c l ol) (do_c a ol) (do_c (do_c b ob) ol)) o1))
          (ensures eq_c (merge_c (do_c l ol) (do_c (do_c a ol) o1) (do_c (do_c (do_c b o) ob) ol)) (do_c (merge_c (do_c l ol) (do_c a ol) (do_c (do_c (do_c b o) ob) ol)) o1))
...
let inter_right_1op (l a b:concrete_st) (o1 ob ol o:op_t) 
  ...
  else if get_key o1 = k && get_key ob = k && get_key ol = k && is_gamma_op o1 && is_gamma_op ob && is_gamma_op ol && is_gamma_op o && Fst_then_snd? (rc_c (get_op_c ob) (get_op_c ol)) && (Fst_then_snd? (rc_c (get_op_c o) (get_op_c ob)) || Snd_then_fst? (rc_c (get_op_c o) (get_op_c ob)) || Fst_then_snd? (rc_c (get_op_c o) (get_op_c ol))) then
    inter_right_1op_c (sel l kc) (sel a kc) (sel b kc) (get_op_c o1) (get_op_c ob) (get_op_c ol) (get_op_c o)
  else ()
...
val inter_left_1op_c (l a b :concrete_st_c) (o1 ob ol o:op_c)
  : Lemma (requires Fst_then_snd? (rc_c ob ol) /\ get_rid ob <> get_rid ol /\
                    (~ (Either? (rc_c o ob)) \/ Fst_then_snd? (rc_c o ol)) /\
                    distinct_ops o1 ob /\ distinct_ops o1 ol /\ distinct_ops o1 o /\ distinct_ops ob ol /\ distinct_ops ob o /\ distinct_ops ol o /\
                    get_rid o <> get_rid ol /\
                    eq_c (merge_c (do_c l ol) (do_c (do_c (do_c a ob) ol) o1) (do_c b ol)) (do_c (merge_c (do_c l ol) (do_c (do_c a ob) ol) (do_c b ol)) o1))
          (ensures eq_c (merge_c (do_c l ol) (do_c (do_c (do_c (do_c a o) ob) ol) o1) (do_c b ol)) (do_c (merge_c (do_c l ol) (do_c (do_c (do_c a o) ob) ol) (do_c b ol)) o1))
...
let inter_left_1op (l a b :concrete_st) (o1 ob ol o:op_t)
  ...
  if get_key o1 = k && get_key ob = k && get_key ol = k && is_alpha_op o1 && is_alpha_op ob && is_alpha_op ol && is_alpha_op o && Fst_then_snd? (rc_a (get_op_a ob) (get_op_a ol)) && (Fst_then_snd? (rc_a (get_op_a o) (get_op_a ob)) || Snd_then_fst? (rc_a (get_op_a o) (get_op_a ob)) || Fst_then_snd? (rc_a (get_op_a o) (get_op_a ol))) then 
    ...
    inter_left_1op_c (sel l kc) (sel a kc) (sel b kc) (get_op_c o1) (get_op_c ob) (get_op_c ol) (get_op_c o)
  else ()
...
val ind_right_1op_c (l a b:concrete_st_c) (o2 o2' ol:op_c)
  : Lemma (requires distinct_ops o2 o2' /\ distinct_ops o2 ol /\ distinct_ops o2' ol /\
                    eq_c (merge_c (do_c l ol) (do_c a ol) (do_c b o2)) (do_c (merge_c (do_c l ol) (do_c a ol) b) o2))
          (ensures eq_c (merge_c (do_c l ol) (do_c a ol) (do_c (do_c b o2') o2)) (do_c (merge_c (do_c l ol) (do_c a ol) (do_c b o2')) o2))
...
let ind_right_1op (l a b:concrete_st) (o2 o2' ol:op_t)
  ...
  else if get_key o2 = k && get_key o2' = k && is_gamma_op o2 && is_gamma_op o2' && is_gamma_op ol then
      ind_right_1op_c (sel l kc) (sel a kc) (sel b kc) (get_op_c o2) (get_op_c o2') (get_op_c ol)
...
val ind_left_1op_c (l a b:concrete_st_c) (o1 o1' ol:op_c)
  : Lemma (requires distinct_ops o1 o1' /\ distinct_ops o1 ol /\ distinct_ops o1' ol /\
                    eq_c (merge_c (do_c l ol) (do_c a o1) (do_c b ol)) (do_c (merge_c (do_c l ol) a (do_c b ol)) o1))
          (ensures eq_c (merge_c (do_c l ol) (do_c (do_c a o1') o1) (do_c b ol)) (do_c (merge_c (do_c l ol) (do_c a o1') (do_c b ol)) o1))
...
let ind_left_1op (l a b:concrete_st) (o1 o1' ol:op_t)
  ...
  else if get_key o1 = k && get_key o1' = k && is_gamma_op o1 && is_gamma_op o1' && is_gamma_op ol then
      ind_left_1op_c (sel l kc) (sel a kc) (sel b kc) (get_op_c o1) (get_op_c o1') (get_op_c ol)
...
val lem_0op_c (l a b:concrete_st_c) (ol:op_c)
  : Lemma (ensures eq_c (merge_c (do_c l ol) (do_c a ol) (do_c b ol)) (do_c (merge_c l a b) ol))
...
let lem_0op (l a b:concrete_st) (ol:op_t)
  ...
  else if is_gamma_op ol then lem_0op_c (sel l kc) (sel a kc) (sel b kc) (get_op_c ol)
  else ()
