...
let commutes_with (o1 o2:op_t) =
  forall s. do_pre s o1 /\ do_pre s o2 /\ do_pre (do s o1) o2 /\ do_pre (do s o2) o1 ==> eq (do (do s o1) o2) (do (do s o2) o1)

let rec apply_pre (x:concrete_st) (l:log) : Tot prop (decreases length l) =
  match length l with
  |0 -> True
  |_ -> do_pre x (head l) /\ apply_pre (do x (head l)) (tail l)

// applying a log of operations to a concrete state
let rec apply_log (x:concrete_st) (l:log{apply_pre x l}) : Tot concrete_st (decreases length l) =
  match length l with
  |0 -> x
...
let rec lem_apply_log (x:concrete_st) (l:log)
  : Lemma (requires apply_pre x l)
          (ensures (length l > 0 ==> apply_pre x (fst (un_snoc l)) /\
...
val fast_fwd_ind (a b:concrete_st) (o2 o2':op_t) (l:log)
  : Lemma (requires do_pre b o2 /\ apply_pre a l /\ merge_pre a a (do b o2) /\
                    ...
                    do_pre b o2' /\ do_pre (do b o2') o2 /\ merge_pre a a (do (do b o2') o2))
